		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Abastecimiento de Almacén a Líneas de Producción",
									"targetURL": "#andinasagaabastecimiento-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"andinasagaabastecimiento-display": {
								"semanticObject": "andinasagaabastecimiento",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=andina.sagaabastecimiento",
									"url": sap.ui.require.toUrl("andina/sagaabastecimiento")
								}
							}
						}
					}
